  ...
  return (
    <>
      <motion.div
        ...
        className="h-[350px] w-[400px] absolute bg-white overflow-hidden pointer-events-none flex items-center justify-center rounded-xl z-50-"
      >
        <div
          style={{ top: index * -100 + "%" }}
      ...
      <motion.div
        ref={cursor}
        className="w-[80px] h-[80px] rounded-full bg-[#1e1e1e] text-[#deddd9] absolute z-[2] flex items-center justify-center text-[14px] font-light pointer-events-none"
        variants={scaleAnimation}
        initial="initial"
        animate={active ? "enter" : "closed"}
      ></motion.div>
