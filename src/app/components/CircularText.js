...
const CircularText = ({
  ...
  return (
    <motion.div
      ...
      className={`mx-auto rounded-full w-[200px] h-[200px] font-second text-[#1e1e1e] font-black text-center cursor-pointer origin-center border border-[#1e1e1e] before:absolute before:inset-9 before:border before:border-[#1e1e1e] before:rounded-full before:content-[''] ${className}`}
      animate={controls}
